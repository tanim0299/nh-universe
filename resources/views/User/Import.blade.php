  ...
  <div class="container-fluid">
    <div>
      <ul class="uk-breadcrumb bg-white p-0 p-3" style="border-radius: 30px;">
        ...
        <li><span class="text-dark font-weight-bold">Import</span></li>
      </ul>
    </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
           ...
           <div class="form-group mform col-sm-12">
            ...
            <div class="form-group mform col-sm-12">
                <input type="submit" value="Submit Now" name="import_btn" class="btn btn-success w-100 rounded">
            </div>
