                                    ...
                                    <tbody>
                                      ...
                                      <tr id="tr-{{$showdata->invoice_id}}">
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-info" onclick="penToProOrder('{{$showdata->invoice_id}}')">Process</a>



                                            
                                            <a class="btn btn-warning" onclick="proToontheOrder('{{$showdata->invoice_id}}')">On the Way</a>
