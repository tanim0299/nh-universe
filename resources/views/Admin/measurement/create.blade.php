                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-shadow mb-4">
                            ...
                            <div class="card-body">
                                <form id="" method="post" class=" right-text-label-form feedback-icon-form" action="{{url('Measurementinsert')}}" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-5">
                                            <input type="text" class="form-control" id="measurement_type" name="measurement_type" placeholder="Measurement name" value="{{old('measurement_type')}}"/>
                                        </div>
                                    </div>
