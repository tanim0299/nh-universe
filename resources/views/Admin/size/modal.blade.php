                    ...
                    <div class="col-md-12">
                        <div class="card card-shadow mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <form method="post" class=" right-text-label-form feedback-icon-form" action="{{route('size-info.update',[$data->id])}}" enctype="multipart/form-data">
                                     @method('PATCH')
                                    @csrf
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-5">
                                            <input type="text" class="form-control" id="size_title" name="size_title" placeholder="size name" value="{{$data->size_title}}"/>
                                        </div>
                                    </div>
