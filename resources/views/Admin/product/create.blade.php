                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="card card-shadow mb-4">
                            ...
                            <div class="card-body">
                  <form method="post" action="{{route('product-add.store')}}" name="basic_validate"  novalidate="novalidate" enctype="multipart/form-data">
                   @csrf
                   <div class="row">
<div class="col-md-6">
            ...
            <input  type="text" name="product_id" id="product_id" class="form-control" placeholder="SMBP01"  style="width: 90%;" value="{{old('product_id')}}" />
                      ...
                      <div class="control-group">
                        <label class="control-label">Show Home Item</label>
                    
                        <div class="controls">
                         <select name="home_item_show" class="form-control" required>
